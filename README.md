...
- For this subql-starter the two main branches to work off are [v0.0.1](https://github.com/subquery/subql-starter/tree/v0.0.1) and [v0.2.0](https://github.com/subquery/subql-starter/tree/v0.0.1), which reference the manifest specVersion's avaliable.
